...
//	c-Gate Arm Status	0-2	Gate Arm Light Status
		LIGHTS_OFF,    // 0 - Off
		LIGHTS_ON,     // 1 - On
	...
	public boolean isOn() {
		return (this == StatusOfWarningSignLights.LIGHTS_ON);
	}

	/** Test if lights are off */
	public boolean isOff() {
		return (this == StatusOfWarningSignLights.LIGHTS_OFF);
	}

	/** Test if lights are in an error state */
	public boolean isError() {
		return (this == StatusOfWarningSignLights.LIGHTS_ERROR);
	}
}
