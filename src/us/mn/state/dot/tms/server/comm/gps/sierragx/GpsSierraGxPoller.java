	...
	public void sendRequest(GpsImpl gps, DeviceRequest r) {
		switch (r) {
			...
			case QUERY_GPS_LOCATION:
				addOp(new OpQueryGpsLocationSierraGx(gps, false));
				break;
			case QUERY_GPS_LOCATION_FORCE:
				addOp(new OpQueryGpsLocationSierraGx(gps, true));
				break;
			default:
