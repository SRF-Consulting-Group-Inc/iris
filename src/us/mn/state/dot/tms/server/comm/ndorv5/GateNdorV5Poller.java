  ...
  implements GateArmPoller
{
	...
	public GateNdorV5Poller(String commLinkName) {
		super(commLinkName, TCP, GATENDORv5_LOG);
		attrCommIdleDisconnect =
				SystemAttrEnum.COMM_IDLE_DISCONNECT_GATE_SEC;
	}
...
//				break;
	...
	public void closeGate(GateArmImpl ga, User o) {
		...
		// into a warn-close state, and then automatically
		// goes into the closing state.
		addOp(new OpMoveGateArm(ga, o, GateArmState.WARN_CLOSE));
	}
}
