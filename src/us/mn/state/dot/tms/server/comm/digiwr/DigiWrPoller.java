...
/**
 * A Poller to communicate with Digi WR-series modems.
 *
 * @author John L. Stanley
 * @author Douglas Lau
 */
public class DigiWrPoller extends ThreadedPoller<AsciiDeviceProperty>
	implements GpsPoller
{
	/** Create a new RedLion GPS poller */
	public DigiWrPoller(CommLink link) {
