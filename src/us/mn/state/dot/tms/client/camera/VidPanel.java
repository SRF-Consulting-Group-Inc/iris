 ...
 *   Optional: Expire streaming after some period of time.
 *
...
//				      && (mouse_ptz != null))
//					stopMousePTZ();   // turn mouse PTZ off
				if (mouse_ptz == null) {
...
//				System.out.println("status: "+panelStatus+", stream: "+streamReqNum+", videoGapSec: "+videoGapSec+", duration: "+videoDurationSec);
...
//	private Action pauseStreamAction = new AbstractAction() {
//		@Override
//		public void actionPerformed(ActionEvent e) {
...
//	};
	...
	public VidStreamMgr getStreamMgr() {
		return streamMgr;
	}
...
//		System.out.println("queueUpdatePanel(): status: "+panelStatus+", pauseMsg: \""+pauseMsg+"\"");
...
//		System.out.println("queueUpdatePanel: "+updatePanelJob.toString()+", delay = "+updatePanelJob.delay());
	}
